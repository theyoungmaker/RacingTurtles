...
def setup_screen():
    ...
    screen.title("The Young Maker - Racing Turtles")
...
def get_userguess():
    return screen.numinput("Guess!",
                           "Which turtle will win? (1, 2, 3 or 4)",
                           minval=1,
                           maxval=4)
...
def race(user_guess: int):
    ...
    for i in range(72):
        if (winner == 1):
          turtle1.right(5)
          turtle1.shapesize(2.5)
        elif (winner == 2):
          turtle2.right(5)
          turtle2.shapesize(2.5)
        elif (winner == 3):
          turtle3.right(5)
          turtle3.shapesize(2.5)
        elif (winner == 4):
          turtle4.right(5)
          turtle4.shapesize(2.5)
